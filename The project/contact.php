...
<center>
	...
	<div id="contact"><P><strong> mail us to contact by this email</strong> <br><br> <a href="mailto:address_of_email@gmail.com">address_of_email@gmail.com</a><br> <br>
	<strong>	or you can call</strong> <br> +966509619610<br></P></div>
</center>
</div>
...
if(isset($_POST['submit'])) {
         ...
         $password = mysqli_real_escape_string($database ,$password);
            ...
            $query = "SELECT * from id_researcher WHERE email= '$email' AND password='$password'";

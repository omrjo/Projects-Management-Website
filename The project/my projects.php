...
$database=mysqli_connect("localhost","root","","rpms");
                    ...
                    $query22="SELECT * FROM projects JOIN researcher_has_project ON projects.id_project=researcher_has_project.id_project
                     WHERE id_researcher=$id_researcher ";             
...
<center>
	<ul>
		...
		echo "<li><a href='' class='s1'>".$row['project_title']."</a>
			        <a href='' class='sp'> 
					<div style='width:120px;'>
				     ".$row['budget']."</div></a></li><hr>";  } ?>

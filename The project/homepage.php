...
<center><p id="p1">welcome to <br><br>Research Projects Management System (RPMS)</p></center>

<section id="a9"><p>
	<center>Our goal : Supporting research projects (for all scientific departments) </center> <br>you will be lucky if you are selected as one of the researchers supported by the deanship pf scientific Research.
</p></section>
<center>
	<!--<div id="a15"><P><a href="reg/login.html">I HAVE AN ACCOUNT</a></P></div>-->
	<a href="reg.php"><div id="a16"><P>I DON'T HAVE AN ACCOUNT</P></div></a>
</center>
...
if(isset($_POST['submit'])) {
         ...
         $password = mysqli_real_escape_string($database ,$password);
			...
			// 5. execute query in Bloggers database
         	...
         	<script type="text/javascript"> window.location.href="http://localhost/group6project/employee.php"; 
           </script>  
         	<?php 
         }else{
         		 ?>

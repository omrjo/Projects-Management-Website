...
<body>
	...
	<section>
		...
		<ul id="a12"><strong id=adep> Departments</strong>
			...
			<a href="employeeph.php" id="a25"><li id="cs">Physics</li></a>
		</ul>
	</div>
</div>
	...
	<div id="a27" style="position: fixed;">
		<ul id="a12">
			<a href="allph.php" id="a25"><li > all researches </li></a>
			<a href="acceptph.php" id="a25"><li>accepted proposals</li></a>
			<a href="rejectph.php" id="a25"><li id="cs">rejected proposals</li></a>
		</ul>
	</div>
</div>
...
<center>
	<ul>
		<?php 
		$database=mysqli_connect("localhost","root","","rpms");
		$query="SELECT * from (proposals, researcher_has_proposal,researchers) where proposals.id_proposal=researcher_has_proposal.id_proposal and researchers.id_researcher=researcher_has_proposal.id_researcher and proposals.state='rejected' and researchers.department='physics'";
		$result=mysqli_query($database,$query);

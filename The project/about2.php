	...
	<header>
		...
		<div id="a20" >
			<ul id=a23>
				...
				<a href="http://localhost/group6project/info.php"><li id="a22"><center><i class="fa fa-user"></i><?php  echo $f_name." ".$l_name; ?></center></li></a>
			</ul>
		</div>
...
<center>
	...
	<div id="about">this website just project , and it is Under maintenance and upon completion of the site will be submitted online completely,<br>Students working on site: <br>-khalled almliki<br>-hammam jaber<br>-rakan alkhteeb<br>-tayseer suidan
		<br>Site Supervisor: Dr. Mohamed Fuad Seriti

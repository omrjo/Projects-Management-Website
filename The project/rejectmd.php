...
<body>
	...
	<section>
		...
		<ul id="a12"><strong id=adep> Departments</strong>
			...
			<a href="employeemd.php" id="a25"><li id="cs"> Medicine </li></a>
	...
	<div id="a27" style="position: fixed;">
		<ul id="a12">
			<a href="allmd.php" id="a25"><li > all researches </li></a>
			<a href="acceptmd.php" id="a25"><li>accepted proposals</li></a>
			<a href="rejectmd.php" id="a25"><li id="cs">rejected proposals</li></a>
		</ul>
	</div>
</div>
...
<center>
	<ul>
		<?php 
		$database=mysqli_connect("localhost","root","","rpms");
		$query="SELECT * from (proposals, researcher_has_proposal,researchers) where proposals.id_proposal=researcher_has_proposal.id_proposal and researchers.id_researcher=researcher_has_proposal.id_researcher and proposals.state='rejected' and researchers.department='medicine'";
		$result=mysqli_query($database,$query);

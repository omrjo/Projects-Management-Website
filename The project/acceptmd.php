...
<body>
	...
	<div id="a27" style="position: fixed;">
		<ul id="a12">
			...
			<a href="acceptmd.php" id="a25"><li id="cs">accepted proposals</li></a>
			<a href="rejectmd.php" id="a25"><li>rejected proposal</li></a>
		</ul>
	</div>
</div>
...
<center>
	<ul>
		<?php 
		$database=mysqli_connect("localhost","root","","rpms");
		$query="SELECT * from (proposals, researcher_has_proposal,researchers) where proposals.id_proposal=researcher_has_proposal.id_proposal and researchers.id_researcher=researcher_has_proposal.id_researcher and proposals.state='accepted' and researchers.department='medicine'";
		$result=mysqli_query($database,$query);

...
<?php     
   ...
   if (move_uploaded_file($_FILES['file']['tmp_name'], $target)) {
        ...
        $msg = "Failed to upload File";
            ...
            $query_insert_title_proposal="INSERT INTO proposals(proposal_title,File) VALUES('$proposal_title','$File')";
            mysqli_query( $database, $query_insert_title_proposal);
 
            $query_select_id_proposal="SELECT id_proposal FROM proposals WHERE proposal_title ='$proposal_title'"; 

...
<body>
	...
	<div id="a27" style="position: fixed;">
		<ul id="a12">
			<a href="allph.php" id="a25"><li id="cs"> all researches </li></a>
...
<?php 
              $database= mysqli_connect("localhost","root","","rpms");
             $query="SELECT * FROM researchers,proposals,researcher_has_proposal WHERE researchers.id_researcher=researcher_has_proposal.id_researcher AND proposals.id_proposal=researcher_has_proposal.id_proposal AND researchers.department='physics'";

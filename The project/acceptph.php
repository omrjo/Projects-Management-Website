...
<body>
	...
	<div id="a27" style="position: fixed;">
		<ul id="a12">
			...
			<a href="acceptph.php" id="a25"><li id="cs">accepted proposals</li></a>
			<a href="rejectph.php" id="a25"><li>rejected proposals</li></a>
...
<center>
	<ul>
		<?php 
		$database=mysqli_connect("localhost","root","","rpms");
		$query="SELECT * from (proposals, researcher_has_proposal,researchers) where proposals.id_proposal=researcher_has_proposal.id_proposal and researchers.id_researcher=researcher_has_proposal.id_researcher and proposals.state='accepted' and researchers.department='physics'";
		$result=mysqli_query($database,$query);

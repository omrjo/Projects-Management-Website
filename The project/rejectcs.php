...
<body>
	<header style="position: fixed; z-index: 100">
		...
		<div id="a20" >
			<ul id=a23>
				<a href="end session.php"><li id="a21"><i class="material-icons">&#xe8ac;</i></li></a>
	...
	<section>
		...
		<ul id="a12"><strong id=adep> Departments</strong>
			<a href="employeecs.php" id="a25"><li id="cs"> Computer Science  </li></a>
	...
	<div id="a27" style="position: fixed;">
		<ul id="a12">
			<a href="allcs.php" id="a25"><li > all researches </li></a>
			<a href="acceptcs.php" id="a25"><li>accepted proposals</li></a>
			<a href="rejectcs.php" id="a25"><li id="cs">rejected proposals</li></a>
		</ul>
	</div>
</div>
...
<center>
	<ul>
		<?php 
		$database=mysqli_connect("localhost","root","","rpms");
		$query="SELECT * from (proposals, researcher_has_proposal,researchers) where proposals.id_proposal=researcher_has_proposal.id_proposal and researchers.id_researcher=researcher_has_proposal.id_researcher and proposals.state='rejected' and researchers.department='computer science'";
		$result=mysqli_query($database,$query);
